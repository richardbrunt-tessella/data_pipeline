...
class Config():
    ...
    ELASTICSEARCH_MAP_ASSOCIATION_INDEX_NAME = 'association-map'
    ELASTICSEARCH_MAP_ASSOCIATION_TARGET_DOC_NAME = 'association-map-target'
    ELASTICSEARCH_MAP_ASSOCIATION_DISEASE_DOC_NAME = 'association-map-disease'
